...
| 설정        | Return 평균±표준편차 (%) | Sharpe 평균±표준편차 | MDD 평균±표준편차 (%) |
|------------|-------------------------|----------------------|-----------------------|
| baseline   | 7.75 ± 23.75            | 0.13 ± 0.16          | 47.51 ± 9.66          |
| high_entropy | 3.98 ± 23.53          | 0.08 ± 0.15          | 47.04 ± 8.18          |
| large_clip | -0.17 ± 25.61           | 0.13 ± 0.17          | 38.30 ± 15.07         |
| low_entropy | 11.03 ± 19.92          | 0.16 ± 0.10          | 38.80 ± 7.88          |
| low_lr     | 20.12 ± 22.48           | 0.20 ± 0.13          | 34.63 ± 7.01          |
| small_clip | 1.13 ± 2.34             | 0.09 ± 0.02          | 37.22 ± 11.66         |

| 설정        | 최고 시드 (ret, MDD)         | 최저 시드 (ret, MDD)          |
|------------|------------------------------|-------------------------------|
| baseline   | seed 0 (27.9%, 48.8%)        | seed 2 (-29.3%, 60.8%)        |
| high_entropy | seed 4 (27.4%, 43.9%)      | seed 3 (-32.9%, 47.4%)        |
| large_clip | seed 0 (25.8%, 14.4%)        | seed 3 (-42.9%, 60.9%)        |
| low_entropy | seed 0 (28.7%, 39.4%)       | seed 2 (-5.8%, 48.0%)         |
| low_lr     | seed 0 (56.6%, 44.7%)        | seed 4 (-1.2%, 30.5%)         |
| small_clip | seed 2 (6.8%, 51.5%)         | seed 3 (-3.2%, 48.9%)         |
